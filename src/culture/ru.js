(function (translator) {
	translator.translations["ru"] = {
		...
		"brainalertpassphrasetooshort": "Введённая парольная фраза слишком коротка.\n\n",
		"brainalertpassphrasewarning": "Предупреждение: Очень важно выбрать сложную парольную фразу, чтобы было невозможно угадать её методом грубого перебора и украсть ваши Dash.",
		"brainalertpassphrasedoesnotmatch": "Парольная фраза и её подтверждение не совпадают.",
		"detailalertnotvalidprivatekey": "Введённый текст не является корректным приватным ключом",
		"detailconfirmsha256": "Введённый текст не является корректным приватным ключем!\n\nВы хотите использовать введённый текст в качестве парольной фразы и создать Приватный Ключ, используя SHA256 для хеширования парольной фразы?\n\nПредупреждение: Очень важно выбрать сложную парольную фразу, чтобы было невозможно угадать её методом грубого перебора и украсть ваши Dash.",
		...
		"bulklabelcsv": "Значения разделённые запятой:",
		...
		"vanitylabelstep1privnotes": "Скопируйте и вставьте приватный ключ в файл. В идеале необходимо сохранить его на зашифрованный диск. Вам будет нужен приватный ключ после того, как пул найдёт интересующий Вас префикс адреса.",
		...
		"vanitylabelnotesprivatekey": "Это Ваш приватный ключ для импорта в другой кошелёк.",
		...
		"detaillabelq1": "Как сделать кошелёк используя игральные кости? Что такое B6?",
